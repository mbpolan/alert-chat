...
class Packet {
	public:
		 ...
		 * data has been read or a time out has been reached. The time out is defined in the
		 * server configuration file, and as such, a different return code will be given. A
